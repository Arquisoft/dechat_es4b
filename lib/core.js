...
class ChatCore {
  ...
  async storeUbication(personal,receiver,message) {	
		this.sendMessage(personal,receiver,message);
  }
  
  async storeAudio(personal,receiver,message) {	
		message = "data/audio$" + message;
		this.sendMessage(personal,receiver,message);
  }
  
  async storeVideo(personal,receiver,message) {	
		message = "data/video$" + message;
		this.sendMessage(personal,receiver,message);
  }

  async storePhoto(personal,receiver,message) {	
		this.sendMessage(personal,receiver,message);
  }
  
  async sendContact(personal,receiver,message) {	
		this.sendMessage(personal,receiver,message);
  }
  ...
  async loadMessages(personal, a, nm, testing){
    ...
    if(receiver == null){
      ...
      this.commPrivate.clearMessages();
