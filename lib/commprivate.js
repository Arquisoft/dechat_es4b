  ...
  */
  ...
  async sendPhoto(personal,core,file){
	  var a = $("#possible-people option:selected").val();
		...
		var extensionFile = getFileExtension(file.name);
		var myUrlFile = "https://"+personal.username+".solid.community/inbox/"+receiver.username+"-"+randomString(10)+extensionFile;
