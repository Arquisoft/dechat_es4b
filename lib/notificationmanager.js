...
class NotificationManager {
  ...
  removePrivateNotification(other){
    this.alerts.clickById(other.username);
    this.removeNotification(other.username);
  }

  removeGroupNotification(group){
    this.alerts.clickById(group.name);
    this.removeNotification(group.name);
  }
