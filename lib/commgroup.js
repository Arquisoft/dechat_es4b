  ...
  */
  async loadMessages(personal, myUrlFile, testing){
    ...
    fc.readFile(group.urlCore).then( (body) => {
      ...
      $("#addMessages").empty(); 
      if(err.includes("403")){ console.log("You have been removed from this group")}else if(err.includes("404")){ console.log("This group has been deleted")} else{console.log(err);}});
  }
