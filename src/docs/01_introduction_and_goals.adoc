...
| _ Project sponsor _ | _ Tim Berners-Lee _ | _ Determine which is the best chat and which best meets the requirements _
| _Professor_ | _Jose Emilio Labra Gayo_ | _Proof that the requirements are met_
| _Community Manager at Solid_ | _Mitzi_ | _ Proof that the requirements are met _
